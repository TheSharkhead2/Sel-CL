CUDA_VISIBLE_DEVICES=0,1,2,3 python3 train_webvision_Sel-CL.py --epoch 130 --num_classes 1000 --batch_size 56 --low_dim 128 --lr-scheduler "step"  \
...
--test_batch_size 56 --beta 0.0 --warmup_way 'sup' --wandb-project "inaturalist"
